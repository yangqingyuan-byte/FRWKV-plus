...
for pred_len in "${pred_lengths[@]}"; do
    ...
    echo "=========================================="
        ...
        python -u run.py \
          ...
          --data_path ETTm2.csv \
          --model_id ETTm2_frwkv_${seq_len}_${pred_len}_seed${seed} \
          --model ${model_name} \
          --data ETTm2 \
          --features M \
          --seq_len ${seq_len} \
          ...
          --dropout ${dropout} \
          --plot_mat_flag 0 \
          2>&1 | tee -a logs/frwkv/FRWKV_ETTm2_${seq_len}_${pred_len}_seed${seed}.log
...
echo "Log file list:"
for pred_len in "${pred_lengths[@]}"; do
    log_file="logs/frwkv/FRWKV_ETTm2_${seq_len}_${pred_len}_seed${seed}.log"
    if [ -f "$log_file" ]; then
        echo "✅ ${log_file}"
    else
...
log_file="logs/frwkv/FRWKV_ETTm2_${seq_len}_*_seed${seed}.log"
