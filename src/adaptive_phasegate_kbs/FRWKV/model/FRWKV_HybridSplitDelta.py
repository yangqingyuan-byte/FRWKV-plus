...
class LinearFreTransformerHybridSplitDelta(nn.Module):
    """
    Conservative hybrid:
    - real-frequency branch keeps the tuned FRWKV block
    - imaginary-frequency branch uses Delta-v2
    """
...
class Model(nn.Module):
    def __init__(self, configs):
        super().__init__()
        self.model = LinearFreTransformerHybridSplitDelta(configs)
