...
from model.FRWKV_HybridSplitDelta import LinearFreTransformerHybridSplitDelta


class LinearFreTransformerHybridSplitDeltaGate(LinearFreTransformerHybridSplitDelta):
...
class Model(nn.Module):
    def __init__(self, configs):
        super().__init__()
        self.model = LinearFreTransformerHybridSplitDeltaGate(configs)
