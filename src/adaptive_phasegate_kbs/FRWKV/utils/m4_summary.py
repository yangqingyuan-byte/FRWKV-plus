...
smape_dict = {'Yearly': 1, 'Quarterly': 1, 'Monthly': 1, 'Weekly': 1, 'Daily': 1, 'Hourly': 1}
mase_dict = {'Yearly': 1, 'Quarterly': 1, 'Monthly': 1, 'Weekly': 1, 'Daily': 1, 'Hourly': 1}
...
class M4Summary:
    ...
    def evaluate(self):
        ...
        for k in grouped_model_mases.keys():
            ...
            # print(grouped_model_mases[k], grouped_naive2_mases[k], grouped_smapes[k], grouped_naive2_smapes[k])
            grouped_owa[k] = (divide_no_nan(grouped_model_mases[k], grouped_naive2_mases[k]) +
                              divide_no_nan(grouped_smapes[k], grouped_naive2_smapes[k])) / 2
    ...
    def summarize_groups(self, scores):
        ...
        scores_summary['Others'] = divide_no_nan(others_score, others_count)
